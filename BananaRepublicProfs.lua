...
local DB_NAME = "BRPDB"
local PREFIX = "BRP0"
local DEBUG = false  -- TEMPORARILY ON for debugging  -- Debug messages OFF by default (use /brp debug to enable)
...
local function uiCreate()
  ...
  shareBtn:SetPoint("BOTTOM", f, "BOTTOM", 0, 12)
  ...
  listBg:SetPoint("BOTTOMRIGHT", recipePage, "BOTTOMRIGHT", -38, 50)  -- 50 from bottom for share button
  listBg:SetBackdrop({
    bgFile = "Interface\\Tooltips\\UI-Tooltip-Background",
    edgeFile = "Interface\\Tooltips\\UI-Tooltip-Border",
    tile = true, tileSize = 16, edgeSize = 16,
